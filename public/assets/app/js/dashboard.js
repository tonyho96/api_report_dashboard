...
jQuery(document).ready(function() {
    Dashboard.init();
    jQuery('.openinfo').on('mouseenter',function(){
        jQuery(this).find('.openrate').hide();
        jQuery(this).find('.uniqueopen').show();
        jQuery(this).parent().find('.clickrate').hide();
        jQuery(this).parent().find('.uniqueclick').show();
    });
    jQuery('.openinfo').on('mouseleave',function(){
        jQuery(this).find('.openrate').show();
        jQuery(this).find('.uniqueopen').hide();
        jQuery(this).parent().find('.clickrate').show();
        jQuery(this).parent().find('.uniqueclick').hide();
    });
    jQuery('.clickinfo').on('mouseenter',function(){
        jQuery(this).find('.clickrate').hide();
        jQuery(this).find('.uniqueclick').show();
        jQuery(this).parent().find('.openrate').hide();
        jQuery(this).parent().find('.uniqueopen').show();
    });
    jQuery('.clickinfo').on('mouseleave',function(){
        jQuery(this).find('.clickrate').show();
        jQuery(this).find('.uniqueclick').hide();
        jQuery(this).parent().find('.openrate').show();
        jQuery(this).parent().find('.uniqueopen').hide();
    });
    jQuery('.subscriberinfo').on('mouseenter',function(){
        jQuery(this).parent().parent().find('.clickrate').hide();
        jQuery(this).parent().parent().find('.uniqueclick').show();
        jQuery(this).parent().parent().find('.openrate').hide();
        jQuery(this).parent().parent().find('.uniqueopen').show();
    });
    jQuery('.subscriberinfo').on('mouseleave',function(){
        jQuery(this).parent().parent().find('.clickrate').show();
        jQuery(this).parent().parent().find('.uniqueclick').hide();
        jQuery(this).parent().parent().find('.openrate').show();
        jQuery(this).parent().parent().find('.uniqueopen').hide();
    });
});